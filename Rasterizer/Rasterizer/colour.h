...
public:
    ...
    colour_rgb(float _r = 0, float _g = 0, float _b = 0) : r(_r), g(_g), b(_b) {}
    ...
    colour_rgb operator*(float scalar) const {
    ...
    colour_rgb operator * (const float scalar) {
        colour_rgb c;
        c.r = r * scalar;
        c.g = g * scalar;
        c.b = b * scalar;
    ...
    colour_rgb operator * (const colour_rgb& col) {
        colour_rgb c;
        c.r = r * col.r;
        c.g = g * col.g;
        c.b = b * col.b;
    ...
    colour_rgb operator + (const colour_rgb& _c) {
        colour_rgb c;
        c.r = r + _c.r;
        c.g = g + _c.g;
        c.b = b + _c.b;
...
public:
    ...
    // - _g: Green component (default 0.0f)
    // - _b: Blue component (default 0.0f)
    colour_opt(float _r = 0, float _g = 0, float _b = 0) : r(_r), g(_g), b(_b), padding(0) {}
    //colour(float _r = 0, float _g = 0, float _b = 0) : r(_r), g(_g), b(_b) {}
    ...
    colour_opt operator*(float scalar) const {
        return { r * scalar, g * scalar, b * scalar };
    }
    ...
    // - scalar: The scaling factor
    // Returns a new `colour` object with scaled components.
    colour_opt operator * (const float scalar) {
        colour_opt c;
        c.r = r * scalar;
        c.g = g * scalar;
        c.b = b * scalar;
    ...
    // - col: The other color to multiply with
    // Returns a new `colour` object with multiplied components.
    colour_opt operator * (const colour_opt& col) {
        colour_opt c;
        c.r = r * col.r;
        c.g = g * col.g;
        c.b = b * col.b;
    ...
    // - _c: The other colour to add
    // Returns a new `colour` object with added components.
    colour_opt operator + (const colour_opt& _c) {
        colour_opt c;
        c.r = r + _c.r;
        c.g = g + _c.g;
        c.b = b + _c.b;
